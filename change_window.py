...
class ChangeWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        # Текст по окну
        self.setWindowTitle('Изменение ранее внесенных данных')
        ...
        set_text(self.ui_2.pushButton, 'Изменить')
        ...
        self.ui_2.pushButton_3.setStyleSheet("""
                                             ...
                                             """)
        self.ui_2.lineEdit_7.setEnabled(False)
        self.ui_2.lineEdit_8.setEnabled(False)
        self.ui_2.lineEdit_9.setEnabled(False)
        self.ui_2.dateEdit_4.setEnabled(False)
    ...
    def get_patient_id(self):
        ...
        patient_id = find_user_id(patient_surname, patient_name, patient_patronymic, patient_birthday)

        return patient_id

    # Передача формы в базу
    def from_form_to_json(self):
        ...
        update_tuple = (organization_name, organization_ogrn, order_date, service_code, service_name, test_system,
                        ...
                        fact_region, fact_building, fact_district, fact_apartment, fact_street, patient_id[0][0])

        update_patient(update_tuple)
